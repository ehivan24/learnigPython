...
static char __pyx_k_Users_edwingsantos_Documents_wo[] = "/Users/edwingsantos/Documents/workspaceJava/learnigPython/hello.pyx";
static PyObject *__pyx_kp_s_Users_edwingsantos_Documents_wo;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Users_edwingsantos_Documents_wo, __pyx_k_Users_edwingsantos_Documents_wo, sizeof(__pyx_k_Users_edwingsantos_Documents_wo), 0, 0, 1, 0},
 ...
 *     for i in range(n):
 */
  __pyx_tuple_ = PyTuple_Pack(4, __pyx_n_s_n, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_i); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_edwingsantos_Documents_wo, __pyx_n_s_fib, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "fib")) {
      if (unlikely(PyDict_SetItemString(modules, "fib", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
